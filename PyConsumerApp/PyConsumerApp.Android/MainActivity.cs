...
namespace PyConsumerApp.Droid
{
    ...
    [Activity(Label = "DailyMart", Icon = "@mipmap/icon", Theme = "@style/MyTheme.Splash", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
